...
public class AutoShotgun extends Gun{
    ...
    public AutoShotgun(double xPos, double yPos, Color col) throws FileNotFoundException {
        super(xPos, yPos, col);
    ...
    public void update() {
        ...
        if(getClickedMouse() && bulletCount%5==0){
            try {
                ...
                if(getLaser()){
                    bullet = new Laser(bulletX, bulletY, Color.BLACK, getTheta());
                    bullet2 = new Laser(bulletX, bulletY, Color.BLACK, getTheta()+5);
                    bullet3 = new Laser(bulletX, bulletY, Color.BLACK, getTheta()-5);
                }
                else{
